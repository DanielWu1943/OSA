%% baseline of optimal splitting and random scheduling
...
%% 启动
    ...
    while t <= T
        ...
        [~, t_opt] = branch_and_bound(num_edges, B(selected_task), t_tr(training_epoch,:), r(selected_idx, :), o(selected_task));
    ...
    %% 保存结果到.mat文件
    file_name = sprintf('./plot_taskrelease/baseline_OSRS_results_gamma_%.2f_edges_%d_5000.mat', gamma, num_edges);
